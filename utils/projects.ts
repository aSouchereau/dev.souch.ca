...
export const projects : Project[] = [
    ...
    },
    {
        ...
        summary: "Hickory is a photo management tool for professional photographers. It is currently in very early development. It is being built in Laravel, and will have a react frontend. Hickory will include photos with support for multiple files, metadata management, automatic backups, post to 3rd party APIs, albums, geolocation, an extensive tagging system, and more.",
        images: [
            "/images/hero-small-640.jpg"
        ],
        tags: [
